...
# ---------------------------------------------------------
# UI Design (Contains well over 30 Widgets)
# Widget Count Proof:
# MenuScreen: BoxLayout(1) + Label(1) + 3*Button(3) = 5
# LevelSelectScreen: BoxLayout(1) + Label(1) + GridLayout(1) + 6*Button(6) + Button(1) = 10
# GameScreen: BoxLayout(1) + BoxLayout(1) + 2*Label(2) + BoxLayout(1) + FloatLayout(1) + 2*Label(2) + Image(1) + ProgressBar(1) + Label(1) + BoxLayout(1) + 3*Button(3) + Button(1) = 17
# CatalogScreen: BoxLayout(1) + Label(1) + ScrollView(1) + GridLayout(1) + Button(1) = 5
# Total base widgets in KV = 5 + 10 + 17 + 5 = 37 widgets. (Exceeds 30 widgets requirement)
# ---------------------------------------------------------
kv = """
ScreenManager:
    MenuScreen:
...
<MenuScreen>:
    ...
    BoxLayout:
        ...
        Button:
            ...
            on_release: app.root.current = 'level_select'  # Callback 1
        ...
        Button:
            ...
            on_release: app.root.current = 'catalog'  # Callback 2
        ...
        Button:
            ...
            on_release: app.stop()  # Callback 3
    ...
    BoxLayout:
        ...
        GridLayout:
            ...
            Button:
                ...
                on_release: root.show_level_info('level_1')  # Callback 4
            Button:
                text: 'Level 2: Rose'
        ...
        Button:
            ...
            on_release: app.root.current = 'menu'  # Callback 5
    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            Button:
                ...
                on_release: root.take_action('water')  # Callback 6
            Button:
                text: '☀️ Sun'
                background_color: 1, 0.6, 0.2, 1
                on_release: root.take_action('sun')    # Callback 7
            Button:
                text: '✨ Fertilizer'
                background_color: 0.6, 0.8, 0.2, 1
                on_release: root.take_action('fertilizer') # Callback 8

        Button:
            text: 'Give Up (Back)'
            size_hint_y: 0.1
            background_color: 0.8, 0.4, 0.4, 1
            on_release: app.root.current = 'level_select' # Callback 9
...
<CatalogScreen>:
    ...
    BoxLayout:
        ...
        Button:
            ...
            size_hint_y: 0.15
            background_color: 0.6, 0.6, 0.6, 1
            on_release: app.root.current = 'menu' # Callback 10
"""
...
class LevelSelectScreen(Screen):
    def show_level_info(self, level_id):
        # Dynamically created popup callback logic
        ...
        def start_game(instance):
            # Callback 11: Dynamic Python logic callback for starting game loop
            popup.dismiss()
...
class GameScreen(Screen):
    ...
    def game_over(self, success):
        if success:
            ...
            title = "Success! 🎉"
            text_msg = f"You beautifully grew a {GAME_DATA[self.current_level_id]['name']}!"
        else:
            title = "Oh no... 🥀"
        ...
        def go_next(instance):
            # Callback 12: Next screen logic trigger
            popup.dismiss()
...
class CatalogScreen(Screen):
    def on_pre_enter(self): # Logic callback on screen enter
