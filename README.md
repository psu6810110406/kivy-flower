...
# 🌻 Apartment Garden: Virtual Plant Simulation

โปรเจกต์พัฒนาเกมจำลองการปลูกดอกไม้ในอพาร์ตเมนต์ พัฒนาด้วยภาษา Python และ Kivy Framework 
มาพร้อมงานศิลปะสไตล์ Pixel Art ที่สวยงามและระบบการเล่นที่ลุ่มลึก

## ✨ ฟีเจอร์หลัก (Key Features)
* **Dynamic Growth System:** ดอกไม้มีการเติบโต 4 ระดับ (Seed -> Sprout -> Growing -> Bloom) แยกตามสายพันธุ์ 
* **Interactive Gardening:** ระบบดูแลพืชที่สมจริง ทั้งการรดน้ำ, ใส่ปุ๋ย, และพรวนดิน 
* **Weather System:** สภาพอากาศในแต่ละวัน (แดดจัด, ฝนตก) ส่งผลต่ออัตราการเติบโต 
* **Collection Mode:** ระบบ Drag & Drop สำหรับจัดวางดอกไม้ที่ปลูกสำเร็จในสวนส่วนตัว
* **Data Persistence:** บันทึกความก้าวหน้าและการสะสมดอกไม้ด้วยระบบฐานข้อมูล JSON

## 📂 โครงสร้างโปรเจกต์ (Project Structure)
* `main.py`: ไฟล์หลักควบคุม Logic การทำงานของแอปพลิเคชัน
* `garden.kv`: ออกแบบ UI ทั้งหมดด้วยภาษา KV Language
* `database.py`: ระบบจัดการบันทึกและโหลดข้อมูลผู้เล่น
* `assets/`: รวบรวมทรัพยากรภาพ Pixel Art และฟอนต์ภาษาไทย

## 🛠️ วิธีติดตั้ง (Installation)
1. ติดตั้ง Library ที่จำเป็น: `pip install kivy Pillow`
